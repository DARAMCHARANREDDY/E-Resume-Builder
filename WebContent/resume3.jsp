...
<div id="doc2" class="yui-t7">
	<div id="inner">
			...
			<div id="yui-main">
				<div class="yui-b">
					...
					<div class="yui-gf">
						...
						<div class="yui-u">
							<p class="enlarge">
								I am a tech enthusiastic ,self-motivated, determinant kind of person keeps my eye on learning and learning until I become expert , love to learn everyday.
							</p>
						</div>
					</div><!--// .yui-gf -->
					...
					<div class="yui-gf last">
						...
						<div class="yui-u">
							<h2>K L University - Vijayawada, India</h2>
							<h3>B.tech, Specialized in web designing <strong>8.0 GPA</strong> </h3>
						</div>
					</div><!--// .yui-gf -->
		...
		<div id="ft">
			<p>vamsi mitra &mdash; <a href="mailto:vamsi@gmail.com">vamsi@gmail.com</a> &mdash; 0123456789</p>
		</div><!--// footer -->
