...
$(document).ready(function()
    ...
    $('.list_add_button').click(function()
        ...
        if(x < list_maxField){ 
            x++; 
            var list_fieldHTML = '<div class="row"><div class="col-xs-4 col-sm-4 col-md-4"><div class="form-group"><select  class="form-control" name="list[0][]" id="skills"><option selected>Level</option><option value="XHTML">XHTML</option><option value="CSS">CSS</option><option value="javascript">javascript</option><option value="jquery">jquery</option><option value="PHP">PHP</option></select>  </div></div><div class="col-xs-1 col-sm-7 col-md-1"><a href="javascript:void(0);" class="list_remove_button btn btn-danger">-</a></div></div>'; //New input field html 
            $('.list_wrapper').append(list_fieldHTML); //Add field html
        }
        else
        	{
        	alert("You can add upto 6 records only");
        	}
        });
            ...
            <div class="col-xs-12 col-sm-8 col-md-8 col-sm-offset-2 col-md-offset-2">
                <div class="panel panel-info">
                    ...
                    <div class="panel-heading text-center">
                        ...
                        <h1 class="panel-title">List out your Technical Skills</h1>
                    </div>
                    <hr>
                    <div class="panel-body">
                        <form role="form" method="post" action="resume3entrypage4.jsp">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-4 col-sm-4 col-md-4">
                                        ...
                                        <div class="form-group">
                                          <label for="list[0][]">TECHNICAL</label>
